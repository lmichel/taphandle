...
public class NodeUrlTest extends RootClass {
	...
	public static void main(String[] args) throws Exception {
		NodeUrl nu = new NodeUrl("http://heasarc.gsfc.nasa.gov/xamin/vo/tap/");
		System.out.println(nu);
		System.out.println(nu.getAbsoluteURL("/xamin/vo/tap/qsqqs"));
		System.out.println(nu.getAbsoluteURL("/qqxamin/vo/tap/qsqqs"));
		nu = new NodeUrl("http://heasarc.gsfc.nasa.gov:8080/xamin/vo/tap?");
		System.out.println(nu.getAbsoluteURL("/xamin/vo/tap/qsqqs"));
		System.out.println(nu.getAbsoluteURL("/qqxamin/vo/tap/qsqqs"));
		System.out.println(nu);
		nu = new NodeUrl("heasarc.gsfc.nasa.gov/xamin/vo/tap/");
		System.out.println(nu);
	}
