...
public class TablesReconstructor extends RootClass {
	...
	private final String query = "Select DB_NAME, SCHEMA_NAME, TABLE_NAME, COLUMN_NAME, DESCRIPTION, UNIT, UCD, DATATYPE, SIZE, PRINCIPAL, INDEXED, STD from tap_schema.columns";
