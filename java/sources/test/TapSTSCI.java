 ...
 *
 */
public class TapSTSCI  extends RootClass {
	private static final String baseDir = System.getProperty("java.io.tmpdir") ;
	private static final String baseUrlN = "http://vao.stsci.edu/CAOMTAP/TapService.aspx/tables";
	...
	public static void main(String[] args) throws Exception {
		...
		for(Object sn: schemas) {
			...
			if( ((String)(s.get("name"))).equals("public") ) {
