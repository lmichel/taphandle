 ...
 *
 */
public class TapJacobs  extends RootClass {
	private static final String baseDir = "/home/michel/Desktop/Jacobs/" ;
	private static final String baseUrlN = "http://epn1.epn-vespa.jacobs-university.de/tap";

	public static void main(String[] args) throws Exception {
		validWorkingDirectory(baseDir + "/nodebase");

		
		RegistryMark rm = new RegistryMark("Jacobs", " ", baseUrlN, "test", false, true);
		TapNode tn = new TapNode(rm, "/home/michel/Desktop/Jacobs/");
